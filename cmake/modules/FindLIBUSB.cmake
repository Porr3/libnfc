...
IF(NOT LIBUSB_FOUND)
  IF(WIN32)
    IF(MINGW)
      FIND_PATH(LIBUSB_INCLUDE_DIRS lusb0_usb.h "LibUSB-Win32/include" NO_SYSTEM_ENVIRONMENT_PATH)
      FIND_LIBRARY(LIBUSB_LIBRARIES NAMES libusb PATHS "LibUSB-Win32/lib/gcc")
      SET(LIBUSB_LIBRARY_DIR "LibUSB-Win32/bin/x86/")
    ELSE(MINGW)
      FIND_PATH(LIBUSB_INCLUDE_DIRS lusb0_usb.h "LibUSB-Win32/include" NO_SYSTEM_ENVIRONMENT_PATH)
      FIND_LIBRARY(LIBUSB_LIBRARIES NAMES libusb PATHS "LibUSB-Win32/lib/msvc_x64")
      SET(LIBUSB_LIBRARY_DIR "LibUSB-Win32/bin/amd64/")
    ENDIF(MINGW)
